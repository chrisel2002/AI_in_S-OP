...
export default function App() {
  ...
  // Use a ref so refresh() always reads the latest typeFilter without re-creating
    ...
    <div className="db">
              ...
              <div className="rule-item" key={r._id}>
                ...
                <div className="row-gap">
                  ...
                  <button className="link-btn" onClick={async () => {
                    ...
                    // Reset filter if we just deleted the active filter type
      ...
      {builder !== null && (
        <RuleBuilder
          ...
          onSaved={(savedName) => {
            setBuilder(null);
            // Auto-select the newly created rule in the dropdown
